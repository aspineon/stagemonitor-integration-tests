...
@SpringApplicationConfiguration(classes = SampleJdbcApplication.class)
@WebIntegrationTest
public class StagemonitorIntegrationTest {
	...
	public static void initStagemonitor() {
		// the earlier stagemonitor is initialized the less files have to be retransformend, which is a expansive operation
		Stagemonitor.init();
	}
